...
const translations = {
  es: {
    ...
    quotes: {
      ...
      exportWord: "Descargar Word",
      exportHtml: "Exportar HTML",
      template: "Plantilla de impresión",
    ...
    templates: {
      title: "Plantillas",
      subtitle: "Personaliza el diseño que usarán tus cotizaciones impresas y descargables.",
      ...
      nameRequired: "El nombre es requerido",
      deleteConfirm: (name) => `¿Eliminar la plantilla "${name}"?`,
  ...
  en: {
    ...
    templates: {
      title: "Templates",
      subtitle: "Customize the design used by printed and downloadable quotations.",
